...
//userDefault存储数据到沙盒
#define SEEKUSERDEFAULT(KEY)     [[NSUserDefaults standardUserDefaults]objectForKey:KEY]
#define SAVEUSERDEFAULT(VALUE,KEY)  [[NSUserDefaults standardUserDefaults] setObject:VALUE forKey:KEY]
